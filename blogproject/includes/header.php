  ...
  <body>
     ...
     <header>
       <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        <a class="navbar-brand" href="#">PN Infosys Blog</a>
      ...
      <div class="row">
        <div class="col-md-8 blog-main">
          ...
          <div class="blog-post">
            ...
            <p class="blog-post-meta"><?php echo formatDate($row['data']); ?><a href="#">&nbsp;by&nbsp;<?php echo $row['author']; ?></a></p>
